<template>
  <div class="areas">
    ...
    <data-loader v-slot="{ results: results, response: response }" :url="`/v1/components/5d4574bf-fb0f-47fe-87e9-c33680aecaf0/data?table=${craneStates.routerMap[routeParams.table]}`" :style="{width: '400px', height: '217px', position: 'absolute', top: '841px', left: '40px'}" :data="[[0]]">
